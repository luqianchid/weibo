    ...
    <div class="container">
		...
		<ul class="list-group hidden-md hidden-sm hidden-xs">
            ...
            <div class="col-md-7">         
                ...
                <?php if(is_array($collect) || $collect instanceof \think\Collection || $collect instanceof \think\Paginator): $i = 0; $__LIST__ = $collect;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?>
                <div class="sendbox">
                    <div class="head-bar p_30">  
                        <div class="head-name m_15"><?php echo $co['uname']; ?></div>
                        <div class="head-time"><?php echo tranTime($co['co_time']); ?></div>  
                    </div>
                    <div class="content-text m_0">
                        收藏了您的微博  //                                                      
                    </div> 
                    <div class="content-text">                         
                        ...
                        <div class="quotes_cont">                            
                            <div class="quotes-head-bar">                               
                                <div class="quotes-head-name"><a href="<?php echo url('Homepage/index',['u'=>$co['puid']]); ?>"><?php echo $co['username']; ?></a></div>
                            </div>
                            <?php if($co['content'] != null): ?>
                            <div class="quotes-content-text">
                                <p><?php echo $co['content']; ?></p>
                            </div>
                            <div class="quotes_func">
                                <div class="quotes-head-time pull-left"><?php echo tranTime($co['add_time']); ?></div>                                
                            </div> 
