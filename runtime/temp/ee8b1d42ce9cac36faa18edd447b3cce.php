<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\www\weibo\public/../application/index\view\editor\Editor.html";i:1557468890;s:52:"D:\www\weibo\application\index\view\common\head.html";i:1548331519;s:51:"D:\www\weibo\application\index\view\common\nav.html";i:1554475637;s:50:"D:\www\weibo\application\index\view\common\js.html";i:1553754266;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="col-md-12 h100">
            ...
            <ul class="art-list">
                ...
                <li class="art-list-item">
                    <div class="art-title-url">
                        <a href="<?php echo url('Article/index',['artid'=>$art['aid']]); ?>"><?php echo $art['title']; ?></a>
                        <div class="edited-time"><?php echo tranTime($art['create_time']); ?></div>
                    </div>
                    <div class="art-ctrl">
    ...
    <div class="col-md-8 right-cont">
        <div class="formup">
            <form action="/index/Editor/SaveArt" class="form-mt" enctype="multipart/form-data" method="post">
                <div class="form-group">
                    <input class="form-title" type="text" name="title" id="art_title" placeholder="请输入标题">
                </div>
                <div class="form-group">
                    <input class="form-intro" type="text" name="intro" id="art_intro" placeholder="请输入引言">
                </div>
                <div class="form-group">
                    <div id="edi" class="form-check" style="height:350px;"></div>
