...
<div class="container">
        ...
        <div class="hots-list">
            ...
            <form action="" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    <label for="imgPreview">上传你的头像</label>
                    <div id="headimgPreview">
                        <div id="prompt3">
                        <span id="imgSpan">
                        点击上传
                            <br />
