        ...
        <div class="hots-list">
                ...
                <div class="focus-box">
                    <div class="focus-cont">
                        <?php if(is_array($fans) || $fans instanceof \think\Collection || $fans instanceof \think\Paginator): $i = 0; $__LIST__ = $fans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f): $mod = ($i % 2 );++$i;?>
                        <div class="focus-row">
                            <div class="focus-cell">
                                <div class="focus-img"><a href="<?php echo url('Homepage/index',['u'=>$f['id']]); ?>"><img src="/static/uploads/<?php echo $f['avatar']; ?>" alt="<?php echo $f['username']; ?>"></a></div>
                                <div class="re-focus">
