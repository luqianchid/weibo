<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"D:\www\weibo\public/../application/index\view\login\Register.html";i:1553432872;s:52:"D:\www\weibo\application\index\view\common\head.html";i:1548331519;s:51:"D:\www\weibo\application\index\view\common\nav.html";i:1554475637;s:54:"D:\www\weibo\application\index\view\common\footer.html";i:1553476963;s:50:"D:\www\weibo\application\index\view\common\js.html";i:1553754266;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
                ...
                <div class="form-bot">
                    ...
                    <form role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="phone" type="text" name="phone" class="form-control" placeholder="手机号">
                        </div>
                        <div class="form-group">
                            <label class="sr-only" for="iemail">邮箱:</label>
                            <input id="iemail" type="email" name="email" class="form-control" placeholder="邮箱">
                        </div>                       
                        <div class="form-group">
                            <input class="form-control btn-primary" type="submit" value="注册" id="register"/>
                        </div>
                    </form>
                </div>
            </div>
