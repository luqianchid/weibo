        ...
        <div class="hots-list">
                ...
                <div class="focus-box">
                    <div class="focus-cont">
                        <?php if(is_array($focus) || $focus instanceof \think\Collection || $focus instanceof \think\Paginator): $i = 0; $__LIST__ = $focus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f): $mod = ($i % 2 );++$i;?>
                        <div class="focus-row">
                            <div class="focus-cell">
                                <div class="focus-img"><a href="<?php echo url('Homepage/index',['u'=>$f['id']]); ?>"><img src="/static/uploads/<?php echo $f['avatar']; ?>" alt=""></a></div>
                                <div class="re-focus">
                                    <div class="focus-name"><?php echo $f['username']; ?></div>
                                    <?php if($user['id']!=\think\Request::instance()->session('uid')): else: ?>
                                    <div class="dis-focus" data-fid="<?php echo $f['id']; ?>">取消关注</div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="focus-cell">
                                <div class="re-focus">
                                    <div class="focus-name"><?php echo $f['email']; ?></div>
                                    <div class="focus-sign"><?php echo $f['signnote']; ?></div>                                    
                                </div>
                            </div>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
