<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\www\weibo\public/../application/admin\view\admin\add.html";i:1553655809;s:52:"D:\www\weibo\application\admin\view\common\head.html";i:1553485941;s:51:"D:\www\weibo\application\admin\view\common\nav.html";i:1553650330;s:52:"D:\www\weibo\application\admin\view\common\left.html";i:1553653608;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="col-md-10 right">
    <form action="" class="form-mt" enctype="multipart/form-data" method="post">
        <div class="form-group">
            <input class="form-title" type="text" name="adminname" placeholder="请输入管理员名称">
        </div>  
        <div class="form-group">
            <input class="form-title" type="text" name="password" placeholder="请输入管理员密码">
        </div> 
        <div class="form-group">
            <div class="btn-box">
