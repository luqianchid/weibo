<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\www\weibo\public/../application/admin\view\talks\index.html";i:1553653077;s:52:"D:\www\weibo\application\admin\view\common\head.html";i:1553485941;s:51:"D:\www\weibo\application\admin\view\common\nav.html";i:1553650330;s:52:"D:\www\weibo\application\admin\view\common\left.html";i:1553653608;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="col-md-10 right">
        ...
        <table class="table table-striped table-bordered">
                <thead class="text-center">
                    <tr>
                        <th class="text-center" width="100px">PostID</th>
                    ...
                    <tbody>   
                    <?php if(is_array($talks) || $talks instanceof \think\Collection || $talks instanceof \think\Paginator): $i = 0; $__LIST__ = $talks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>   
                    <tr>
                        <td align="center"><?php echo $t['pid']; ?></td>
                        <td align="center"><?php echo $t['content']; ?></a></td>
                        <td align="center"><?php echo $t['username']; ?></td>  
                        <td align="center"><?php echo date("m-d H:i",$t['add_time']); ?></td>                              
                        <td align="center">                                    
                            <a href="<?php echo url('talks/del',['pid'=>$t['pid']]); ?>" onClick="warning('确实要删除吗')" class="btn btn-danger btn-sm shiny">
