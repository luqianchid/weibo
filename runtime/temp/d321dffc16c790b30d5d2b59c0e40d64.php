<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:64:"D:\www\weibo\public/../application/index/view/common/right2.html";i:1553756629;s:62:"D:\www\weibo\public/../application/index/view/common/left.html";i:1553744628;s:62:"D:\www\weibo\public/../application/index\view\index\index.html";i:1553936240;s:52:"D:\www\weibo\application\index\view\common\head.html";i:1548331519;s:51:"D:\www\weibo\application\index\view\common\nav.html";i:1554475637;s:55:"D:\www\weibo\application\index\view\common\leftbar.html";i:1557536289;s:54:"D:\www\weibo\application\index\view\common\right1.html";i:1553487091;s:56:"D:\www\weibo\application\index\view\common\rightbar.html";i:1557536289;s:54:"D:\www\weibo\application\index\view\common\footer.html";i:1553476963;s:50:"D:\www\weibo\application\index\view\common\js.html";i:1553754266;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
		...
		<ul class="list-group hidden-md hidden-sm hidden-xs">
            ...
            <div class="col-md-7">
                ...
                <!--xunhuan-->
                <?php if(is_array($my_post) || $my_post instanceof \think\Collection || $my_post instanceof \think\Paginator): $i = 0; $__LIST__ = $my_post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
                <div class="sendbox">
                    <div class="head-bar">
                        <div class="head-image"><a href="<?php echo url('Homepage/index',['u'=>$m['user_id']]); ?>"><img src="/static/uploads/<?php echo $m['avatar']; ?>" alt="<?php echo $m['username']; ?>"></a></div>
                        <div class="head-name m_15"><?php echo $m['username']; ?></div>
                        <div class="head-time"><?php echo tranTime($m['add_time']); ?></div>
                        <?php if($m['user_id'] != \think\Request::instance()->session('uid')): else: ?>    
                        <div class="dropdown head-menu off">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a class="del" data-post="<?php echo $m['pid']; ?>">删除这条微博</a></li>                    
                            </ul>
                        </div>                   
                        <?php endif; ?>
                    </div>
                    <div class="content-text">
                        ...
                        <div class="text"><?php echo $m['content']; ?>//</div>
                        <div class="glyphicon glyphicon-triangle-top gray_font"></div>
                        <div class="quotes_cont">                            
                            <div class="quotes-head-bar">                               
                                <div class="quotes-head-name"><a href="<?php echo url('Homepage/index',['u'=>$m['uid']]); ?>"><?php echo $m['username']; ?></a></div>
                            </div>
                            <?php if($m['tcont'] != null): ?>
                            <div class="quotes-content-text">
                                <p><?php echo $m['tcont']; ?></p>
                            </div>
                            <div class="quotes_func">
                                <div class="quotes-head-time pull-left"><?php echo tranTime($m['ttime']); ?></div>                                
                            </div> 
                            <?php else: ?>   
                            <div class="quotes-content-text">
                                <p>对方已删除该条说说</p>
                    ...
                    <div class="func-action">
                        <ul class="list-func">                           
                            ...
                            <li class="list-func-item comment" post="<?php echo $m['pid']; ?>"><a href="<?php echo url('index/getcomment',['pid'=>$m['pid']]); ?>"><span class="glyphicon glyphicon-list-alt"></span><i>评论</i></a></li>
		...
		<div class="user_show">
            ...
            <div class="hot_topic">
                    ...
                    <div class="hot_ul">
                        <ul class="list-group">
                            <?php if(is_array($artlist) || $artlist instanceof \think\Collection || $artlist instanceof \think\Paginator): $i = 0; $__LIST__ = $artlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>
		...
		<div class="admin_post">
				...
				<div class="hot_ul">
						<ul class="list-group">
																<li class="list-group-item"><a href="/index/info/index/infoid/7.html">一二三四</a><span class="pull-right">11分钟前</span></li>
