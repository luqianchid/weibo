        ...
        <div class="hots-list">
            ...
            <form action="" method="POST" style="margin-top:20px;">
                <div class="form-group">
                    ...
                    <input type="text" id="username" class="form-control" value="<?php echo $user['username']; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="form-send">
                        ...
                        <select id="sex" name="sex" class="form-control" value=<?php echo $user['sex']; ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone" class="form-control" value="<?php echo $user['phone']; ?>">
                </div>
                <div class="form-group">
                    <label for="signnote">签名</label>
                    <input type="text" id="signnote" class="form-control" value="<?php echo $user['signnote']; ?>">
                </div>
                
                <div class="form-group">
                    <input type="button" class="btn btn-primary" value="提交" type="submit">
                </div>
            </form>
...
<script src="/static/index/js/layer/layer.js"></script>
    ...
    $('.btn').click(function(){
        ...
        let email = $('#email').val();
        let phone = $('#phone').val();
        let sign = $('#signnote').val();
        let sex= $('#sex').val();
        $.ajax({
            url:'changeset',
            type:'post',
            data:{'username':username,'password':password,'email':email,'phone':phone,'sign':sign,'sex':sex},
            success:function(data){
                if (data === 1){
                    layer.msg('您已成功修改');
                }else{
                    layer.msg('您并没有修改任何数据')
                }
            }
        });
    });    
