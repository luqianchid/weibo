<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:65:"D:\www\weibo\public/../application/index\view\index\comments.html";i:1555423266;s:52:"D:\www\weibo\application\index\view\common\head.html";i:1548331519;s:51:"D:\www\weibo\application\index\view\common\nav.html";i:1554475637;s:55:"D:\www\weibo\application\index\view\common\leftbar.html";i:1557536160;s:54:"D:\www\weibo\application\index\view\common\right1.html";i:1553487091;s:56:"D:\www\weibo\application\index\view\common\rightbar.html";i:1557536160;s:54:"D:\www\weibo\application\index\view\common\footer.html";i:1553476963;s:50:"D:\www\weibo\application\index\view\common\js.html";i:1553754266;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
		...
		<ul class="list-group hidden-md hidden-sm hidden-xs">
            ...
            <div class="col-md-7">              
                ...
                <?php if(is_array($post) || $post instanceof \think\Collection || $post instanceof \think\Paginator): $i = 0; $__LIST__ = $post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
                <div class="sendbox">
                    <div class="head-bar">
                        <div class="head-image"><a href="<?php echo url('Homepage/index',['userid'=>$m['user_id']]); ?>"><img src="/static/uploads/<?php echo $m['avatar']; ?>" alt="用户名"></a></div>
                    ...
                    <div class="func-action">
                        <ul class="list-func">
                            <?php if($praise!=0): ?>
                            <li class="list-func-item praise" data-post="<?php echo $m['pid']; ?>" data-parent="<?php echo $m['user_id']; ?>">
                            ...
                            <?php endif; if($collect!=0): ?>
                            <li class="list-func-item collects" data-post="<?php echo $m['pid']; ?>" data-parent="<?php echo $m['user_id']; ?>">
                    ...
                    <div class="sendbox_comment_show">
                        ...
                        <div class="func-area">
                            <div class="kind">                                
                                <button class="sub_com btn btn-primary pull-right" post="<?php echo $m['pid']; ?>"><span class="glyphicon glyphicon-send"></span>发布</button>
                            </div>
                            ...
                            <li>
                                <div class="comlist">
                                    <div class="comment-img">
                                        <a href="<?php echo url('homepage/index',['userid'=>$m['user_id']]); ?>"><img src="/static/uploads/<?php echo $c['avatar']; ?>" alt="<?php echo $c['username']; ?>"></a>
                                        <a href="<?php echo url('homepage/index',['userid'=>$m['user_id']]); ?>">
                                            <div><?php echo $c['username']; ?>:</div>
                                        </a>
                                    </div>                              
                                    <div class="comment-text">
                                        <div class="com-content"><?php echo $c['content']; ?></div>
                                        <div class="time"><?php echo tranTime($c['add_time']); ?></div>
                                    </div>
                                    <div class="reply">
                                        <a href="<?php echo url('index/getcomment',['pid'=>$c['pid']]); ?>">回复</a>
                                    </div>
                                </div>  
                            </li>
