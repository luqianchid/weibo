<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\www\weibo\public/../application/index\view\cate\detail.html";i:1553741983;s:52:"D:\www\weibo\application\index\view\common\head.html";i:1548331519;s:51:"D:\www\weibo\application\index\view\common\nav.html";i:1554475637;s:54:"D:\www\weibo\application\index\view\common\footer.html";i:1553476963;s:50:"D:\www\weibo\application\index\view\common\js.html";i:1553754266;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
		<meta charset="UTF-8">
...
<div id="content">
		...
		<div class="container">
				<div class="width_1000">
						<?php if(is_array($detail) || $detail instanceof \think\Collection || $detail instanceof \think\Paginator): $i = 0; $__LIST__ = $detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?>
						<div class="art-bg"><img src="<?php echo $d['img_url']; ?>"/></div>
						<div class="article-bd">
								...
								<div class="article-info">
										<ul class="art-info">
												<li><a href="<?php echo url('cate/index',['cateid'=>$d['cateid']]); ?>"><?php echo $d['cateid']; ?></a></li>
                                                <li><a>发布于<?php echo $d['create_time']; ?></a></li>
                                                <li class="pull-right"><a href="<?php echo $d['ori_url']; ?>">原文链接</a></li>
										</ul>
								</div>
								<div class="article-cont">
									<div class="article-detail">
										<div class="article-intro">
												<div class="article-i-style"><?php echo intro($d['content']); ?></div>
										</div>
										<div class="article-richtext">
                                            <?php echo $d['content']; if($d['img_url'] != ''): ?>
                                            <img src="<?php echo $d['img_url']; ?>">
                                            <?php else: endif; ?>
										</div>												
									</div>
								</div>
						...
						<div class="article-nominate">
								...
								<div class="article-no-list">
										<ul class="art-no-list">
												<?php if(is_array($calist) || $calist instanceof \think\Collection || $calist instanceof \think\Paginator): $i = 0; $__LIST__ = $calist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?>
												<li class="art-no-li-item">
														<a class="nomi-title" href="<?php echo url('Cate/detail',['cateid'=>$li['cateid'],'caid'=>$li['ca_id']]); ?>"><?php echo $li['title']; ?></a>
														<p><?php echo intro($li['content']); ?></p>
												</li>
												<?php endforeach; endif; else: echo "" ;endif; ?>
										</ul>
										<a class="ul-bot" href="<?php echo url('Cate/index',['cateid'=>$li['cateid']]); ?>">查看更多</a>
								</div>
						</div>
				</div>
		</div>
