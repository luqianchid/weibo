    ...
    <div class="container">
		...
		<ul class="list-group hidden-md hidden-sm hidden-xs">
            ...
            <div class="col-md-7">         
                ...
                <div class="sendbox">
                    <div class="head-bar">
                        <div class="head-image"><a href="<?php echo url('Homepage/index',['u'=>$m['user_id']]); ?>"></a><img src="/static/uploads/<?php echo $m['avatar']; ?>" alt="用户名"></div>
