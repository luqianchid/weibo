...
<div id="content">
    ...
    <div class="container">
		...
		<ul class="list-group hidden-md hidden-sm hidden-xs">
            ...
            <!--内容区域-->
            <div class="col-md-7">
               <div class="title-bar"><i class="glyphicon glyphicon-fire"></i><span>好友头条</span></div>
                <!--开始文章列表-->
                ...
                <div class="article-box">
                    <div class="article-body">
                        <div class="article-content">
                            <div class="art-img"><a href="<?php echo url('Article/index',['artid'=>$art['aid']]); ?>"><img src="/static/upcover/<?php echo $art['cover']; ?>" alt="<?php echo $art['title']; ?>"></a></div>
                            <div class="art-title">
                                <a href="<?php echo url('Article/index',['artid'=>$art['aid']]); ?>" class="a_t"><?php echo $art['title']; ?></a>
                                <div class="time"><?php echo tranTime($art['create_time']); ?></div>
                                <div class="desc">
                                    <?php echo $art['intro']; ?>
                                    <a href="<?php echo url('Article/index',['artid'=>$art['aid']]); ?>" style="color: darkgray">阅读全文</a>
                                </div>
                            </div>
                        </div>
                    </div>
