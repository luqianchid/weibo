<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:66:"D:\www\weibo\public/../application/index\view\index\mycollect.html";i:1554476284;s:52:"D:\www\weibo\application\index\view\common\head.html";i:1548331519;s:51:"D:\www\weibo\application\index\view\common\nav.html";i:1554475637;s:55:"D:\www\weibo\application\index\view\common\leftbar.html";i:1557420521;s:54:"D:\www\weibo\application\index\view\common\right1.html";i:1553487091;s:56:"D:\www\weibo\application\index\view\common\rightbar.html";i:1557420521;s:54:"D:\www\weibo\application\index\view\common\footer.html";i:1553476963;s:50:"D:\www\weibo\application\index\view\common\js.html";i:1553754266;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
		...
		<ul class="list-group hidden-md hidden-sm hidden-xs">
				...
				<li class="list-group-item"><a href="/index/index/index.html">首页</a></li>
								<li class="list-group-item"><a href="/index/cate/index/cateid/1.html">新闻组</a></li>
            ...
            <div class="col-md-7">         
                ...
                <?php if(is_array($mycollect) || $mycollect instanceof \think\Collection || $mycollect instanceof \think\Paginator): $i = 0; $__LIST__ = $mycollect;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
                <div class="sendbox">
                    <div class="coll_text">您收藏了这条说说</div>
                    <div class="content-text">                         
                        <div class="glyphicon glyphicon-triangle-top gray_font"></div>
                        <div class="quotes_cont">                            
                            <div class="quotes-head-bar">                               
                                <div class="quotes-head-name"><a href="<?php echo url('Homepage/index',['u'=>$m['puid']]); ?>"><?php echo $m['username']; ?></a></div>
                            </div>
                            <?php if($m['content'] != null): ?>
                            <div class="quotes-content-text">
                                <p><?php echo $m['content']; ?></p>
                            </div>
                            <div class="quotes_func">
                                <div class="quotes-head-time pull-left"><?php echo tranTime($m['add_time']); ?></div>                                
                            </div> 
                            <?php else: ?>   
                            <div class="quotes-content-text">
                                <p>对方已删除该条说说</p>
                    ...
                    <div class="func-action">
                        <ul class="list-func"> 
                            ...
                            <li class="list-func-item comment" post="<?php echo $m['post_id']; ?>"><a href="<?php echo url('index/getcomment',['pid'=>$m['post_id']]); ?>"><span class="glyphicon glyphicon-list-alt"></span><i>评论</i></a></li>
                        </ul>
                    </div>                    
                </div>
		...
		<div class="admin_post">
				...
				<div class="hot_ul">
						<ul class="list-group">
																<li class="list-group-item"><a href="/index/info/index/infoid/2.html">新学期计划发表集合</a><span class="pull-right">17分钟前</span></li>
																<li class="list-group-item"><a href="/index/info/index/infoid/6.html">xingnggao</a><span class="pull-right">8小时前 16:13:21</span></li>
																...
																<li class="list-group-item"><a href="/index/info/index/infoid/3.html">今年下半年</a><span class="pull-right">03-25 17:14:02</span></li>
														</ul>
				</div>
		</div>
</div>
