<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\www\weibo\public/../application/admin\view\unit\edit.html";i:1553653055;s:52:"D:\www\weibo\application\admin\view\common\head.html";i:1553485941;s:51:"D:\www\weibo\application\admin\view\common\nav.html";i:1553650330;s:52:"D:\www\weibo\application\admin\view\common\left.html";i:1553653608;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="col-md-10 right">
    <form action="/admin/Unit/saveunit" class="form-mt" method="post">
        ...
        <div class="form-group">
            <input value="<?php echo $u['catename']; ?>" class="form-title" type="text" name="catename">
        </div> 
        <div class="form-group">      
            <input class="form-title" type="hidden" name="uid" value=<?php echo $u['cateid']; ?> readonly>  
        </div>
